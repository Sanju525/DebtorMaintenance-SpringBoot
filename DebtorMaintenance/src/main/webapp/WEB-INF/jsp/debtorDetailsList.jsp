...
<script type="text/javascript">
  alertFunc("Debtor Rejected Successfully!");
</script>
<% session.removeAttribute("reject"); %>
<%}%>
    ...
    <div class="row row-cols-1 justify-content-evenly">
      <div class=" card col-8 shadow-lg bg-body rounded" style="padding: 0">
        <div class="card-header">
          <strong>Transaction ID:</strong> ${debtor.getTxnId()}
        </div>
        <div class="card-body">
          <div class="row mb-3">
          ...
          <div class="button text-center">
            <button class="btn btn-secondary" id="viewmore"><a class="link-light" href="/admin/debtor/form/details/${debtor.getTxnId()}">View Details</a></button>
            <button class="btn btn-success" id="authorize"><a class="link-light" href="/admin/debtor/authorize/${debtor.getTxnId()}">Authorize</a></button>
            <button class="btn btn-danger" id="reject"><a class="link-light" href="/admin/debtor/reject-form/${debtor.getTxnId()}">Reject</a></button>
